...
public class CommentServlet extends HttpServlet {
   ...
   * @throws IOException
   */
  public void commentInsert(HttpServletRequest request, HttpServletResponse response)
      throws IOException {
   ...
   * @throws IOException
   */
  public void getCommentListByArticleId(HttpServletRequest request, HttpServletResponse response)
      throws IOException {
   ...
   * @throws IOException
   */
  public void deleteCommentByCommentId(HttpServletRequest request, HttpServletResponse response)
      throws IOException {
